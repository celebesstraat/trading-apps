...
import {
  ...
  fetchQuoteBatch,
  fetchHistorical5mCandlesForRVol,
  fetchTodayIntradayCandlesBatch,
  isAPIConfigured
} from './marketData.js';
import {
  storeTicks,
...
import { getMovingAverages, calculateADRPercent, evaluate5mORB, calculateVRS5m, calculateAvgFirst5mVolume } from './calculations';
import { calculateRVol, isMarketHours } from '../utils/rvolCalculations';
import { isORBActive } from '../utils/marketTime';
import { getRealTimeCalculationEngine } from './realtimeCalculationEngine.js';
...
export class DataIngestionEngine {
  ...
  async buildMinuteCandleIfNeeded(symbol, timestamp) {
    const minuteBoundary = Math.floor(timestamp / 60000) * 60000;
